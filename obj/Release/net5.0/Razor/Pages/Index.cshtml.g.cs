#pragma checksum "C:\Users\emmen\source\repos\ElijahsPortfolioWebsite\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c7a9ebb9fda35d98da3f794e61ace0f0338cbc14"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c7a9ebb9fda35d98da3f794e61ace0f0338cbc14", @"/Pages/Index.cshtml")]
...
#nullable disable
            WriteLiteral(@"
<h1 class=""display-4 text-center mb-3"">Welcome to my page</h1>
<div class=""card mb-3"">
    ...
    <p class=""card-body"">
        ...
        My name is Elijah Mentch, and I am a recent Computer Science graduate from University of
        Wisconsin-Madison. I have programming experience in Java, JS, C, and Python
        through my undergrad. I am currently looking for Software Developer
        jobs locally (1 hour driving distance from West Bend, WI). This website
...
<div class=""card-deck mb-3"">
    <div class=""card"">
        ...
        <ul ");
            WriteLiteral(@"class=""card-body ml-2"">
            <li><b>Languages: </b>Java, Python, JavaScript/CSS/HTML, C, PHP, C#, SQL</li>
            <li><b>Platforms: </b>Windows 10, Linux/Ubuntu</li>
            <li><b>Technologies: </b>Azure, Git, Bash</li>
            <li><b>Frameworks/Libraries: </b>ASP.NET Core, sqlite3, .NET, Bootstrap</li>
            ...
            <li>Enthusiastic, self-driven, fast-learner</li>
            <li>Analytically-oriented and observant</li>
        </ul>
    </div>

    <div class=""card"">
        <h2 class=""card-header""><a href=""https://guide.wisc.edu/courses/comp_sci/"">Relevant Coursework</a></h2>
        <ul class=""card-body ml-2"">
            <li>Introduction to Networks</li>
            <li>Introduction to Operating Systems</li>
            <l");
            WriteLiteral(@"i>Introduction to Compilers</li>
